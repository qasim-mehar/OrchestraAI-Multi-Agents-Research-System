...
def web_scrape(url: str) -> str:
    ...
    # We use a dictionary to search both 'class' and 'id' attributes
    clutter_selectors = [
    ...
    # 5. Extract Text while Preserving Paragraphs
    ...
    for line in cleaned_lines:
        ...
        if word_count + len(line_words) <= 3000:
            ...
            # Add the remaining words needed to hit 3000 exactly
